...
class ServerAgent {
  ...
  async processMessage(parsedData) {
    try {
      ...
      You are acting as an agent living in a simulated 2 dimensional universe. Your goal is to move in circular patterns at ALL times. 
      ...
      * Sleep
      ...
      Your goal is to move in circular patterns at ALL times. 
      ...
      Sleepiness:
      ${parsedData.sleepiness} out of 2
